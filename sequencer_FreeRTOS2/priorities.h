...
#define PRIORITY_TASK_ONE     (THIRTYHZ_PRIORITY)
#define PRIORITY_TASK_TWO     (TENHZ_PRIORITY)
#define PRIORITY_TASK_THREE   (FIVEHZ_PRIORITY)
#define PRIORITY_TASK_FOUR    (TENHZ_PRIORITY)
#define PRIORITY_TASK_FIVE    (FIVEHZ_PRIORITY)
#define PRIORITY_TASK_SIX     (TENHZ_PRIORITY)
#define PRIORITY_TASK_SEVEN   (ONEHZ_PRIORITY)
